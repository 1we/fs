/*
 C++ program to write student objects with Variable – Length records 
 using any suitable record structure and to read from this file a student record using RRN.
*/
#include<stdio.h>
#include<stdlib.h>
#include<iostream.h>
